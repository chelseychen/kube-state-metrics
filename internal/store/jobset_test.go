...
func TestJobSetStore(t *testing.T) {
	...
	const metadata = `
		...
		# HELP kube_jobset_ready_replicas The Number of ready replicas per replicated jobs in a jobset.
		# TYPE kube_jobset_ready_replicas gauge
		# HELP kube_jobset_succeeded_replicas The Number of succeeded replicas per replicated jobs in a jobset.
		# TYPE kube_jobset_succeeded_replicas gauge
		# HELP kube_jobset_failed_replicas The Number of failed replicas per replicated jobs in a jobset.
		# TYPE kube_jobset_failed_replicas gauge
		# HELP kube_jobset_active_replicas The Number of active replicas per replicated jobs in a jobset.
		# TYPE kube_jobset_active_replicas gauge
		# HELP kube_jobset_suspended_replicas The Number of suspended replicas per replicated jobs in a jobset.
		# TYPE kube_jobset_suspended_replicas gauge
	...
	cases := []generateMetricsTestCase{
		{
			...
			Want: metadata + `
				...
				kube_jobset_ready_replicas{jobset_name="RunningJobSet1",namespace="ns1",replicated_job_name="replicated-jobs-1"} 1
				kube_jobset_ready_replicas{jobset_name="RunningJobSet1",namespace="ns1",replicated_job_name="replicated-jobs-2"} 6
				kube_jobset_succeeded_replicas{jobset_name="RunningJobSet1",namespace="ns1",replicated_job_name="replicated-jobs-1"} 2
				kube_jobset_succeeded_replicas{jobset_name="RunningJobSet1",namespace="ns1",replicated_job_name="replicated-jobs-2"} 7
				kube_jobset_failed_replicas{jobset_name="RunningJobSet1",namespace="ns1",replicated_job_name="replicated-jobs-1"} 3
				kube_jobset_failed_replicas{jobset_name="RunningJobSet1",namespace="ns1",replicated_job_name="replicated-jobs-2"} 8
				kube_jobset_active_replicas{jobset_name="RunningJobSet1",namespace="ns1",replicated_job_name="replicated-jobs-1"} 4
				kube_jobset_active_replicas{jobset_name="RunningJobSet1",namespace="ns1",replicated_job_name="replicated-jobs-2"} 9
				kube_jobset_suspended_replicas{jobset_name="RunningJobSet1",namespace="ns1",replicated_job_name="replicated-jobs-1"} 5
				kube_jobset_suspended_replicas{jobset_name="RunningJobSet1",namespace="ns1",replicated_job_name="replicated-jobs-2"} 10

...
func jobSetMetricFamilies(allowAnnotationsList, allowLabelsList []string) []generator.FamilyGenerator {
	return []generator.FamilyGenerator{
		...
		*generator.NewFamilyGeneratorWithStability(
			...
			"The Number of ready replicas per replicated jobs in a jobset.",
			metric.Gauge,
			basemetrics.ALPHA,
			"",
			wrapJobSetFunc(func(js *jobsetv1alpha2.JobSet) *metric.Family {
		...
		*generator.NewFamilyGeneratorWithStability(
			...
			"The Number of succeeded replicas per replicated jobs in a jobset.",
			metric.Gauge,
			basemetrics.ALPHA,
			"",
			wrapJobSetFunc(func(js *jobsetv1alpha2.JobSet) *metric.Family {
		...
		*generator.NewFamilyGeneratorWithStability(
			...
			"The Number of failed replicas per replicated jobs in a jobset.",
			metric.Gauge,
			basemetrics.ALPHA,
			"",
			wrapJobSetFunc(func(js *jobsetv1alpha2.JobSet) *metric.Family {
		...
		*generator.NewFamilyGeneratorWithStability(
			...
			"The Number of active replicas per replicated jobs in a jobset.",
			metric.Gauge,
			basemetrics.ALPHA,
			"",
			wrapJobSetFunc(func(js *jobsetv1alpha2.JobSet) *metric.Family {
		...
		*generator.NewFamilyGeneratorWithStability(
			...
			"The Number of suspended replicas per replicated jobs in a jobset.",
			metric.Gauge,
			basemetrics.ALPHA,
			"",
			wrapJobSetFunc(func(js *jobsetv1alpha2.JobSet) *metric.Family {
